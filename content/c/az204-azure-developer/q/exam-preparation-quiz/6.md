...
answers:
    - id: "answer1"
      title: "Attach the OS disk to a recovery VM as drive E:, and start the VM"
      correct: true
    ...
    - id: "answer3"
      title: "Run: sfc /image:E:\\ /unlock-image"
      correct: false
    ...
    - id: "answer4"
      title: "Run: dism /Image:E:\\ /abort-update"
      correct: false
    ...
    - id: "answer5"
      title: "Run: dism /image:E:\\ /get-packages > c:\\temp\\log.txt"
      correct: true
    ...
    - id: "answer7"
      title: "Run: dism /Image:E:\\ /remove-package /PackageName:{package to delete}"
      correct: true
    ...
    - id: "answer8"
      title: "Run: sfc /Image:E:\\ /finalize-update"
      correct: false
...
You work as a Systems Administrator for MDFT Pro, a well-known training agency that operates virtual training labs for students learning Azure technologies. Mark, the IT Operations Manager, has reported that one of the development VMs provisioned for the instructor training environment has become unresponsive. 

The VM is stuck in a Windows update process and won't start up anymore, preventing trainers from accessing their development tools and course materials. The VM was being used to demonstrate application deployment scenarios to students when the update began. You need to resolve this issue quickly to restore access to the training environment.
