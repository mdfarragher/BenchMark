...
You have a Fabric lakehouse that contains the following data.

| Table name         | Column name      | Data type     |
|-------------------|------------------|---------------|
| PublicHolidays| CountryOrReqion  | Varchar(8000) |
| PublicHolidays| HolidayName      | Varchar(8000) |
| PublicHolidays| Date             | Date          |
| Sales         | OrderDate        | Date          |
| Sales         | Quantity         | Float         |
| Sales         | UnitPrice        | Float         |
