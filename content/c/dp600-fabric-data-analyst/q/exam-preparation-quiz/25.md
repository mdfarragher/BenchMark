...
answers:
    ...
    - id: "answer4"
      title: "PBIT"
      correct: true
      explain: "PBIT (Power BI Template) files are specifically designed for this scenario. They contain the complete report structure, formatting, and predefined data source connections, but do NOT include any actual data. This makes them perfect for creating reusable report templates that multiple teams can use with their own data."
