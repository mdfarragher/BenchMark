...
answers:
    ...
    - id: "answer2"
      title: "Some"
      correct: true
      explain: "Some transformation steps can be folded back to the source. Steps 1-2 (Source, Navigation 1) can fold. However, step 3 (Capitalize each word) breaks folding because it's a text transformation not supported by the source. All subsequent steps (4-7) cannot fold because they follow the breaking step."
    - id: "answer3"
      title: "None"
