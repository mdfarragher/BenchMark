...
answers:
    ...
    - id: "answer2"
      ...
      correct: true
      explain: "Sensitivity labels are the mechanism by which DLP policies are applied to Fabric items. When you apply sensitivity labels to semantic models and reports, the associated DLP policies (like DLP1) automatically take effect on those items, controlling data protection and compliance."
    - id: "answer3"
...
You work for MDFT Pro, a well-known training agency that operates a Fabric tenant with a workspace named **WORKSPACE**. The workspace contains a semantic model with two Microsoft Power BI reports. You have set up a Microsoft 365 subscription that contains a data loss prevention (DLP) policy named **DLP1**.
