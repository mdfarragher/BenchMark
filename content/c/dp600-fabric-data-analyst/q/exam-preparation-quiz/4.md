...
MDFT Pro has a Fabric tenant containing a lakehouse named **Lakehouse1**. The lakehouse contains a Delta table named **students** with eight columns. You receive new data that contains the same eight columns plus two additional columns.
