...
answers:
    ...
    - id: "answer2"
      ...
      correct: true
      explain: "When query folding fails, the Power Query engine must process all data locally instead of pushing operations to the source. For a large dataset with complex calculated columns, this causes resource exhaustion as the engine tries to process 5 years of data in memory. Query folding is essential for efficient incremental refresh."
    - id: "answer3"
