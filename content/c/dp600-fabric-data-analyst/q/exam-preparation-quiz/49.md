...
answers:
    ...
    - id: "answer2"
      ...
      correct: true
      explain: "The withColumn method transforms a column by replacing it with a new version. The col function references the existing 'age' column, and cast('int') converts it to integer type. This returns a DataFrame with all four columns, including the transformed 'age' column."
    - id: "answer3"
