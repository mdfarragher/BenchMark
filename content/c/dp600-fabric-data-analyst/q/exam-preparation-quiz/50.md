...
answers:
    ...
    - id: "answer3"
      title: "GREATEST"
      correct: true
      explain: "The GREATEST function returns the largest value from a list of expressions. It compares the three price columns and returns whichever has the highest value, which is exactly what the HighestPrice column requires."
    - id: "answer4"
      title: "IIF"
