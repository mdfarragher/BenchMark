...
answers:
    ...
    - id: "answer3"
      title: "Lookup"
      correct: true
      explain: "The Lookup activity can execute stored procedures and return their result sets, making the returned values available to downstream activities in the pipeline. This is the correct activity for executing a stored procedure and capturing its output for later use."
    - id: "answer4"
