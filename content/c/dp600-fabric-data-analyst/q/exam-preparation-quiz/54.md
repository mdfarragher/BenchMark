...
answers:
    ...
    - id: "answer4"
      title: "License mode"
      correct: true
      explain: "XMLA endpoints are a Premium capacity feature. To enable XMLA connectivity for the semantic model, you must upgrade the workspace from Pro license mode to Premium capacity (or Premium Per User). Once upgraded, XMLA endpoints become available for use."
