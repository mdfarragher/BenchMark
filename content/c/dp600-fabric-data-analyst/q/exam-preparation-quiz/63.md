...
answers:
    ...
    - id: "answer4"
      title: "DATETRUNC"
      correct: true
      explain: "DATETRUNC is specifically designed to truncate a date to a specified precision, such as year, quarter, month, week, or day. Using DATETRUNC(month, EnrollmentDate) will return the first day of the month for the given EnrollmentDate, which is exactly what is required for the PeriodDate column."
