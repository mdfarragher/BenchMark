...
answers:
    ...
    - id: "answer3"
      title: "weekday"
      correct: true
      explain: "The 'weekday' parameter is the correct datepart parameter for the DATENAME function to return the full name of the day of the week (such as 'Monday', 'Tuesday', 'Wednesday', etc.) for a given date."
    - id: "answer4"
      title: "weekdayname"
