...
answers:
    ...
    - id: "answer4"
      title: "Table.Profile"
      correct: true
      explain: "Table.Profile analyzes a table and returns comprehensive statistical information about all columns, including maximum values for all numeric columns. This function is specifically designed to provide data profiling information such as min, max, average, standard deviation, count, null count, and distinct count for each column in the dataset."
