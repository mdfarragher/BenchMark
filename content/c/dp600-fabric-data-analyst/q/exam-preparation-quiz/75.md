...
answers:
    ...
    - id: "answer2"
      title: "Table.Profile"
      correct: true
      explain: "Table.Profile is a Power Query function that analyzes a table and returns comprehensive statistical information for each column. It provides exactly the statistics requested: count, average, null count, distinct count, and standard deviation, along with other useful metrics like min, max, and error count."
    - id: "answer3"
      title: "Table.View"
